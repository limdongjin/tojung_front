    ...
    <section class="policy">
      <div class="policy_text">
        <p style="text-align:center">
          <span style="font-size:14px"><strong>이용약관</strong></span>
        </p>
        ...
        <p>
          <span style="font-size:14px"
            >이 약관은 투정(전자상거래 사업자)이&nbsp;운영하는
            <span style="color:null">투정</span>(이하 “몰”이라 한다)에서
        ...
        <p>
          <span style="font-size:14px"
            >① “몰”이란 <span style="color:null">투정이</span>&nbsp;재화 또는
        ...
        <p>
          <span style="font-size:14px"
            ><strong>제3조 (약관 등의 명시와 설명 및 개정)&nbsp;</strong></span
          >
        </p>
        <p>&nbsp;</p>
        <p>
          <span style="font-size:14px"
            ...
            <span style="color:#b12424"><strong>투정</strong></span
            >의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가
            연결화면을 통하여 볼 수 있도록 할 수 있습니다.</span
          >
        </p>
        <p>&nbsp;</p>
        <p>
        ...
        <p>
          <span style="font-size:14px"
            ...
            고의 또는 과실이 없음을 입증하는 경우에는 그러하지 아니합니다.</span
          >
        </p>
        <p>&nbsp;</p>
        <p>
          <span style="font-size:14px"
            ...
            또는 현금으로 이용자에게 지급합니다.</span
          >
        </p>
        <p>&nbsp;</p>
        <p>
          <strong
            ><span style="font-size:14px">제6조(회원가입)&nbsp;</span></strong
          >
        </p>
        <p>&nbsp;</p>
        <p>
        ...
        <p>
          <strong
            ><span style="font-size:14px">제8조(회원에 대한 통지)</span></strong
          >
        </p>
        <p>&nbsp;</p>
        <p>
        ...
        <p>
          <span style="font-size:14px"
            ...
            (동의를 받은 사항이 변경되는 경우에도 같습니다.)</span
          >
        </p>
        <p>&nbsp;</p>
        <p>
          <span style="font-size:14px"
            ...
            고지절차와 동의절차를 거치지 않아도 됩니다.</span
          >
        </p>
        <p>&nbsp;</p>
        <p>
          <strong
            ><span style="font-size:14px">제10조 (계약의 성립)</span></strong
          >
        </p>
        <p>&nbsp;</p>
        <p>
          <span style="font-size:14px"
            ...
            계약을 취소할 수 있다는 내용을 고지하여야 합니다.</span
          >
        </p>
        <p>&nbsp;</p>
        <p>
        ...
        <p>&nbsp;</p>
        <p>
          <span style="font-size:14px"><strong>제11조(지급방법)</strong></span>
        </p>
        <p>&nbsp;</p>
        <p>
          <span style="font-size:14px"
            ...
            지급방법에 대하여 재화 등의 대금에 어떠한 명목의 수수료도추가하여
            징수할 수 없습니다.</span
          >
        </p>
        <p>&nbsp;</p>
        ...
        <p>
          <strong
            ><span style="font-size:14px">제13조(재화 등의 공급)</span></strong
          >
        </p>
        <p>&nbsp;</p>
        <p>
        ...
        <p>&nbsp;</p>
        <p>
          <span style="font-size:14px"><strong>제14조(환급)</strong></span>
        </p>
        <p>&nbsp;</p>
        <p>
          <span style="font-size:14px"
        ...
        <p>
          <strong
            ><span style="font-size:14px">제15조(청약철회 등)</span></strong
          >
        </p>
        <p>&nbsp;</p>
        <p>
          <span style="font-size:14px"
            ...
            달리 정함이 있는 경우에는 동 법 규정에 따릅니다.&nbsp;</span
          >
        </p>
        <p>&nbsp;</p>
        <p>
        ...
        <p>
          <strong
            ><span style="font-size:14px">제17조(개인정보보호)</span></strong
          >
        </p>
        <p>&nbsp;</p>
        <p>
        ...
        <p>
          <span style="font-size:14px"
            ...
            자를최소한으로 제한하여야 하며 신용카드, 은행계좌 등을 포함한
            이용자의 개인정보의 분실, 도난, 유출, 동의 없는 제3자 제공, 변조
            등으로 인한 이용자의 손해에 대하여 모든 책임을 집니다.</span
          >
        </p>
        <p>&nbsp;</p>
        <p>
        ...
        <p>
          <strong
            ><span style="font-size:14px">제18조(“몰“의 의무)</span></strong
          >
        </p>
        <p>&nbsp;</p>
        <p>
        ...
        <p>
          <strong
            ><span style="font-size:14px"
              >제19조(회원의 ID 및 비밀번호에 대한 의무)</span
            ></strong
          >
        </p>
        <p>&nbsp;</p>
        ...
        <p>
          <strong
            ><span style="font-size:14px">제20조(이용자의 의무)</span></strong
          >
        </p>
        <p>&nbsp;</p>
        <p>
        ...
        <p>&nbsp;</p>
        <p>
          <strong><span style="font-size:14px">제23조(분쟁해결)</span></strong>
        </p>
        <p>&nbsp;</p>
        <p>
          <span style="font-size:14px"
            >① “몰”은 이용자가 제기하는 정당한 의견이나 불만을 반영하고 그
            피해를 보상처리하기 위하여 피해보상처리기구를 설치․운영합니다.</span
          >
        </p>
        <p>&nbsp;</p>
        <p>
        ...
        <p>
          <span style="font-size:14px"
            >부 칙(시행일) 이 약관은&nbsp;<span style="color:null"
              >2018년 3월 1일</span
            >부터 시행합니다.</span
          >
        </p>
